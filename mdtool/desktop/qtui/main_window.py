"""Main window — app shell of ``mdtool`` (PySide6).
...
from mdtool._version import get_version
from mdtool.desktop.qtui.icons import nav_icon, tray_icon
from mdtool.desktop.qtui.logbus import get_log_bus
from mdtool.desktop.qtui.theme import THEMES
...
class MainWindow(QMainWindow):
    ...
    def _build_pages(self):
        ...
        from mdtool.desktop.qtui.tabs.migrate import MigrateTab
        from mdtool.desktop.qtui.tabs.search import SearchPage
        from mdtool.desktop.qtui.tabs.space_fix import SpaceFixTab
