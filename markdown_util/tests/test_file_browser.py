...
def test_plan_zip_depth_prefix(kb):
    from qtui.tabs.file_browser import plan_zip_bundle
...
def test_plan_zip_many_depth_and_dedupe(tmp_path):
    from qtui.tabs.file_browser import plan_zip_bundle_many
...
def test_search_md_job(kb):
    from qtui.tabs.file_browser import _search_md_job
...
def test_export_db_job(kb):
    from qtui.tabs.file_browser import _export_db_job
